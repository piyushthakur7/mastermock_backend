...
const baseMockTestSchema = z.object({
...
export const createMockTestSchema = baseMockTestSchema.refine(
...
export const updateMockTestSchema = baseMockTestSchema.partial();
